...
vertex Out vertexShader(uint vid [[vertex_id]], constant In *vertexs [[buffer(0)]])
{
    Out out;
...
fragment float4 fragmentShader(Out input [[stage_in]], texture2d<float> textureY [[texture(0)]], texture2d<float> textureUV [[texture(1)]], texture2d<float> uv [[texture(2)]], constant bool &isTest[[buffer(0)]])
{
    if (isTest) {
